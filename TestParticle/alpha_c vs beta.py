...
#m=1
#x=1
#logbeta1=arange(-2, 3.1, 0.01) 
#logbeta2=arange(3.1, 4.1, 0.1)
#logbeta=concatenate((logbeta1, logbeta2))
#beta=10**logbeta
#
#
#a_c=[]
...
plt.figure()
plt.xscale('log')
plt.scatter(beta, a_c,cmap='jet', c=theta)
plt.colorbar(label=r'$\theta_{final}$')
plt.xlabel(r'$\beta$')
plt.ylabel(r'$\alpha_c$')
plt.grid()
plt.show()
